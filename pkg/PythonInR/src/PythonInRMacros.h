/* --------------------------------------------------------------------------  \
   ...
   TODO: Cleanup this definition has gotten messy! 
...
#define R_TO_C_INT_V(n,i)       INTEGER(n)[i]
...
// TODO: Make the naming again consistent since Python 3 internally still uses old style string
	...
	#define R_TO_PY_INT(n) R_TO_PY_LONG(n)
